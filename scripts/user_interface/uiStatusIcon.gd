...
func _process(_delta):
	...
	if flicker_tween != null and flicker_tween.is_valid() and attached_status.duration == 1 and !attached_status.permanent and CombatGlobals.getCombatScene().active_combatant == attached_status.afflicted_combatant and !flicker_tween.is_running():

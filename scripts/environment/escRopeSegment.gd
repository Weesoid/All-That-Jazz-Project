...
func _input(event):
	if Input.is_action_just_pressed('ui_accept') and player_on_segment and OverworldGlobals.getPlayer().isMovementAllowed() and OverworldGlobals.getPlayer().climbing:
